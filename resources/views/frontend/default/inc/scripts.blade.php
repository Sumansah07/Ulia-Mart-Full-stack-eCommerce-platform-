...
<script src="{{ staticAsset('frontend/default/assets/js/api-integration.js') }}"></script>
<script src="{{ staticAsset('frontend/default/assets/js/footer-custom.js') }}"></script>
<script src="{{ staticAsset('frontend/default/assets/js/zoom-lens-fix.js') }}"></script>
<script src="{{ staticAsset('frontend/default/assets/js/quantity-selector.js') }}"></script>
<script src="{{ staticAsset('frontend/default/assets/js/vertical-product-card.js') }}"></script>
...
<script>
    ...
    TT.localize = {
        ...
        addingToCart: '{{ localize('Adding to Cart...') }}',
        buyNow: '{{ localize('Buy it now') }}',
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            window.location.href = '{{ route('checkout.proceed') }}';
                        } else {
    ...
    $(document).on('submit', '.checkout-form', function(e) {
        var isLoggedIn = typeof isLoggedInUser !== 'undefined' ? isLoggedInUser : {{ auth()->check() ? 'true' : 'false' }};
...
<!-- Cart Sidebar Script -->
<script src="{{ staticAsset('frontend/default/assets/js/cart-sidebar.js') }}"></script>

<!-- Sticky Header Script -->
<script src="{{ staticAsset('frontend/default/assets/js/sticky-header.js') }}"></script>
