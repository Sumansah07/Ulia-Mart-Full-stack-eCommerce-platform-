<div class="vertical-product-card rounded-2 position-relative {{ isset($bgClass) ? $bgClass : '' }}" style="cursor: pointer;" onclick="navigateToProduct(event, '{{ route('products.show', $product->slug) }}')">
