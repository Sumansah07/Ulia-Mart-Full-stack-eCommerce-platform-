<div class="vertical-product-card rounded-2 position-relative d-md-flex align-items-center bg-white hr-product" style="cursor: pointer;" onclick="navigateToProduct(event, '{{ route('products.show', $product->slug) }}')">
    ...
    <div class="card-content w-100">
        ...
        @if ($isVariantProduct)
            <a href="javascript:void(0);" class="btn btn-outline-secondary btn-sm mt-4"
            ...
            <form action="" class="direct-add-to-cart-form">
                ...
                @else
                    <a href="javascript:void(0);" onclick="directAddToCartFormSubmit(this)"
                        class="btn btn-outline-secondary btn-sm mt-4 direct-add-to-cart-btn add-to-cart-text">{{ localize('Add to Cart') }}</a>
                @endif
            </form>
        @endif
