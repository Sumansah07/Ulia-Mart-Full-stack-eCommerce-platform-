<div class="horizontal-product-card d-sm-flex align-items-center p-3 bg-white rounded-2 border card-md gap-4" style="cursor: pointer;" onclick="navigateToProduct(event, '{{ route('products.show', $product->slug) }}')">
    ...
    <div class="card-content mt-4 mt-sm-0 w-100">
        ...
        @else
            <form action="" class="direct-add-to-cart-form">
                ...
                <input type="hidden" value="1" name="quantity" class="cart-quantity-input">

                <div class="d-flex align-items-center mt-10 mb-2">
                    ...
                    @if (getSetting('enable_reward_points') == 1)
                        <span class="fs-xxs fw-bold ms-auto" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-title="{{ localize('Reward Points') }}">
                            <i class="fas fa-medal"></i> {{ $product->reward_points }}
                        </span>
                    @endif
