                ...
                <div class="category-section mb-5">
                            ...
                            <div class="d-none d-lg-flex align-items-center">
                                ...
                                <a href="{{ route('products.index') }}?category_id={{ $category->id }}"
                                   class="btn btn-link text-decoration-none fw-bold text-primary p-0">
                                    {{ localize('VIEW ALL') }} <i class="fas fa-arrow-right ms-1"></i>
                                </a>
                            </div>
                    ...
                    <div class="position-relative">
                        ...
                        @if($categoryProducts->count() > 4)
                            <button class="carousel-nav-btn carousel-prev" data-category="{{ $category->id }}"
                            ...
                            <button class="carousel-nav-btn carousel-next" data-category="{{ $category->id }}"
                        ...
                        <div class="products-carousel-container" data-category="{{ $category->id }}"
                            ...
                            <div class="products-carousel-track d-flex" style="gap: 15px; padding: 5px 0;">
                                @foreach ($categoryProducts as $product)
                                    <div class="product-carousel-item flex-shrink-0 lazy-product-card"
                                        ...
                                        <div class="vertical-product-card rounded-2 position-relative swiper-slide product-hover-zoom bg-white"
                                             ...
                                             onclick="navigateToProduct(event, '{{ route('products.show', $product->slug) }}')">
                                    @php
                                    ...
                                    <div class="thumbnail position-relative text-center" style="height: 170px; padding: 15px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                                        <img data-src="{{ uploadedAsset($product->thumbnail_image) }}"
                                ...
                                <div class="product-carousel-item view-all-item flex-shrink-0"
                                     ...
                                     data-aos="fade-up"
                                     data-aos-duration="600"
                                     data-aos-delay="{{ $categoryProducts->count() * 100 }}">
                                    <div class="view-all-card rounded-2 position-relative bg-light border d-flex flex-column align-items-center justify-content-center text-center h-100"
                                         ...
                                         onclick="window.location.href='{{ route('products.index') }}?category_id={{ $category->id }}'">
                                        ...
                                        <!-- View All Text -->
                                        <h6 class="fw-bold text-dark mb-2">{{ localize('View All') }}</h6>
                                        <p class="text-muted mb-0 small">{{ $category->collectLocalization('name') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
