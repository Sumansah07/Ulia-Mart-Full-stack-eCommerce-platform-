    ...
    <ul class="nav nav-tabs border-0 d-block account-nav-menu" role="tablist">
        ...
        <li>
            <a href="{{ route('customers.settings') }}"
                class="{{ areActiveRoutes(['customers.settings'], 'active') }}">
                <span class="me-2">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 10.5C9.38071 10.5 10.5 9.38071 10.5 8C10.5 6.61929 9.38071 5.5 8 5.5C6.61929 5.5 5.5 6.61929 5.5 8C5.5 9.38071 6.61929 10.5 8 10.5Z" fill="#5D6374"/>
                        <path d="M14.6 9.8C14.5 9.5 14.5 9.3 14.5 9V7C14.5 6.7 14.5 6.5 14.6 6.2C14.7 5.9 14.8 5.7 15 5.5C15.2 5.3 15.2 5.1 15.1 4.9L14.1 3.1C14 2.9 13.8 2.8 13.6 2.9C13.4 3 13.2 3 12.9 3C12.6 3 12.3 2.9 12 2.7C11.7 2.5 11.5 2.3 11.4 2C11.3 1.7 11.3 1.4 11.4 1.2C11.5 1 11.4 0.8 11.2 0.7L9.4 -0.3C9.2 -0.4 9 -0.4 8.8 -0.2C8.6 0 8.4 0.1 8.1 0.2C7.8 0.3 7.5 0.3 7.2 0.2C6.9 0.1 6.7 0 6.5 -0.2C6.3 -0.4 6.1 -0.4 5.9 -0.3L4.1 0.7C3.9 0.8 3.8 1 3.9 1.2C4 1.4 4 1.6 3.9 1.9C3.8 2.2 3.7 2.5 3.5 2.7C3.3 2.9 3 3.1 2.7 3.2C2.4 3.3 2.2 3.3 2 3.2C1.8 3.1 1.6 3.2 1.5 3.4L0.5 5.2C0.4 5.4 0.4 5.6 0.6 5.8C0.8 6 0.9 6.2 1 6.5C1.1 6.8 1.1 7.1 1 7.4C0.9 7.7 0.8 7.9 0.6 8.1C0.4 8.3 0.4 8.5 0.5 8.7L1.5 10.5C1.6 10.7 1.8 10.8 2 10.7C2.2 10.6 2.4 10.6 2.7 10.7C3 10.8 3.3 10.9 3.5 11.1C3.7 11.3 3.9 11.6 4 11.9C4.1 12.2 4.1 12.4 4 12.6C3.9 12.8 4 13 4.2 13.1L6 14.1C6.2 14.2 6.4 14.2 6.6 14C6.8 13.8 7 13.7 7.3 13.6C7.6 13.5 7.9 13.5 8.2 13.6C8.5 13.7 8.7 13.8 8.9 14C9.1 14.2 9.3 14.2 9.5 14.1L11.3 13.1C11.5 13 11.6 12.8 11.5 12.6C11.4 12.4 11.4 12.2 11.5 11.9C11.6 11.6 11.7 11.3 11.9 11.1C12.1 10.9 12.4 10.7 12.7 10.6C13 10.5 13.2 10.5 13.4 10.6C13.6 10.7 13.8 10.6 13.9 10.4L14.9 8.6C15 8.4 15 8.2 14.8 8C14.8 8 14.7 7.9 14.6 9.8ZM8 12C5.8 12 4 10.2 4 8C4 5.8 5.8 4 8 4C10.2 4 12 5.8 12 8C12 10.2 10.2 12 8 12Z" fill="#5D6374"/>
                    </svg>
                </span>
                {{ localize('Settings') }}
            </a>
