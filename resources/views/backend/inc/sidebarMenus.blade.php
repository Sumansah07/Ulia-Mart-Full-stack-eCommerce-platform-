...
<ul class="tt-side-nav searchMenu">
    ...
    @canany(['refund_configurations', 'refund_requests', 'approved_refunds', 'rejected_refunds'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($refundsActiveRoutes, 'tt-menu-item-active') }}" style="display: none;">
    ...
    @canany(['reward_configurations', 'set_reward_points'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($rewardsActiveRoutes, 'tt-menu-item-active') }}" style="display: none;">
    ...
    @endphp
    @canany(['newsletters', 'subscribers', 'email_marketing'])
                    ...
                    @can('newsletters')
                        <li class="{{ areActiveRoutes(['admin.newsletters.index'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.newsletters.index') }}"
                                class="{{ areActiveRoutes(['admin.newsletters.index']) }}">{{ localize('Quick Send') }}</a>
                        </li>
                    @endcan

                    @can('email_marketing')
                        <li class="{{ areActiveRoutes(['admin.email-marketing.templates.*'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.email-marketing.templates.index') }}"
                                class="{{ areActiveRoutes(['admin.email-marketing.templates.*']) }}">{{ localize('Email Templates') }}</a>
                        </li>
                        <li class="{{ areActiveRoutes(['admin.email-marketing.campaigns.*'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.email-marketing.campaigns.index') }}"
                                class="{{ areActiveRoutes(['admin.email-marketing.campaigns.*']) }}">{{ localize('Email Campaigns') }}</a>
                        </li>
                    @endcan
                    ...
                    @can('subscribers')
                        <li class="{{ areActiveRoutes(['admin.subscribers.index'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.subscribers.index') }}"
                                class="{{ areActiveRoutes(['admin.subscribers.index']) }}">{{ localize('Subscribers') }}</a>
                        </li>
                    @endcan
                    @can('email_marketing')
                        <li class="{{ areActiveRoutes(['admin.email-marketing.templates.sample-variables'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.email-marketing.templates.sample-variables') }}"
                                class="{{ areActiveRoutes(['admin.email-marketing.templates.sample-variables']) }}">{{ localize('Edit Variables Values') }}</a>
                        </li>
                    @endcan
                </ul>
            </div>
    ...
    @canany(['homepage'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($groceryActiveRoutes, 'tt-menu-item-active') }}">
            <a data-bs-toggle="collapse" href="#groceryOutlook"
                ...
                <span class="tt-nav-link-text">{{ localize('Uliaa') }}</span>
            </a>
    ...
    @canany(['homepage'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($halalActiveRoutes, 'tt-menu-item-active') }}" style="display: none;">
 ...
 @canany(['homepage'])
     <li class="side-nav-item nav-item {{ areActiveRoutes($furnitureActiveRoutes, 'tt-menu-item-active') }}" style="display: none;">
        ...
        <li class="side-nav-item nav-item {{ areActiveRoutes($commonOutlookActiveRoutes, 'tt-menu-item-active') }}">
            ...
            <div class="collapse {{ areActiveRoutes($commonOutlookActiveRoutes, 'show') }}" id="commonOutlook">
                <ul class="side-nav-second-level">
                    ...
                    <li class="{{ areActiveRoutes(['admin.appearance.theme'], 'tt-menu-item-active') }}" style="display: none;">
        ...
        <li class="side-nav-item nav-item {{ areActiveRoutes($settingsActiveRoutes, 'tt-menu-item-active') }}">
            ...
            <div class="collapse {{ areActiveRoutes($settingsActiveRoutes, 'show') }}" id="systemSetting">
                <ul class="side-nav-second-level">
                    ...
                    @can('otp_settings')
                        <li class="{{ areActiveRoutes(['admin.settings.otpSettings'], 'tt-menu-item-active') }}" style="display: none;">
                    ...
                    @can('social_login_settings')
                        <li class="{{ areActiveRoutes(['admin.settings.socialLogin'], 'tt-menu-item-active') }}" style="display: none;">
                    ...
                    @endcan
                    @if (isAdmin())
                        <li class="{{ areActiveRoutes(['admin.about-update'], 'tt-menu-item-active') }}" style="display: none;">
