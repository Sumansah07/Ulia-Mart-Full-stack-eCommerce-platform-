...
<footer class="admin-main-footer">
            ...
            <div class="row">
                <div class="col-md-2 mb-4 mb-md-0">
                    <div class="admin-footer-logo">
                        <img src="{{ staticAsset('frontend/default/assets/images/uliaa-mart-logo.jpeg') }}" alt="Uliaa Mart" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="row">
    ...
    <li>
        ...
        <span style="font-size: 18px;">{{ getSetting('topbar_location') }}</span>
    </li>
    <li>
        <a href="tel:{{ getSetting('navbar_contact_number') }}" class="admin-footer-icon">
            <i data-feather="phone"></i>
        </a>
        <span style="font-size: 18px;">{{ getSetting('navbar_contact_number') }}</span>
    </li>
    <li>
        <a href="mailto:{{ getSetting('topbar_email') }}" class="admin-footer-icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
                <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/>
            </svg>
        </a>
        <span style="font-size: 18px;">{{ getSetting('topbar_email') }}</span>
    </li>
</ul>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.privacyPolicy') }}"style="font-size: 18px;">Privacy Policy</a>
                                </li>
                                <li>
                                    <span class="admin-footer-icon">
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.shippingDeliveryPolicy') }}"style="font-size: 18px;">Shipping & Delivery Policy</a>
                                </li>
                                <li>
                                    <span class="admin-footer-icon">
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.returnRefundPolicy') }}" style="font-size: 18px;">Return & Refund Policy</a>
                                </li>
                            </ul>
                        </div>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.paymentPolicy') }}" style="font-size: 18px;">Payment Policy</a>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.aboutUs') }}" style="font-size: 18px;">About Us</a>
                                </li>
                                <li>
                                   <span class="admin-footer-icon">
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="16" height="16">
    <path d="M10.59 16.59 15.17 12 10.59 7.41 12 6l6 6-6 6-1.41-1.41zM4.59 16.59 9.17 12 4.59 7.41 6 6l6 6-6 6-1.41-1.41z"/>
                                    ...
                                    <a href="{{ route('home.pages.contactUs') }}" style="font-size: 18px;">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
@media (max-width: 390px) {
    .copyright-section {
        ...
        <div class="admin-social-links">
                       <a href="{{ getSetting('facebook_link') }}" target="_blank" class="admin-social-icon">
...
<a href="{{ getSetting('instagram_link', 'https://www.instagram.com/uliaatradingforus/') }}" target="_blank" class="admin-social-icon">
...
<a href="{{ getSetting('youtube_link') }}" target="_blank" class="admin-social-icon">
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="14" height="14">
...
<a href="{{ getSetting('tiktok_link', 'https://www.tiktok.com/@uliaa.mart?_t=ZS-8yNHKZLM09Z&_r=1') }}" target="_blank" class="admin-social-icon">
  <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="14" height="14">
