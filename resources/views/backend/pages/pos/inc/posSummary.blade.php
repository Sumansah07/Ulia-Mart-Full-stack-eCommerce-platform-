  @php
      ...
      $discountType = 'flat';
      $subtotal = getSubTotal($carts, false, '', false) + getTotalTaxWithCouponDiscount($carts, '');

      // to convert input price to base price - use helper function to get valid currency
  ...
  <div class="tt-pos-calculation mb-3">
      ...
      <div class="tt-pos-cal">
          ...
          <strong>{{ formatPrice(getTotalTaxWithCouponDiscount($carts, '')) }}</strong>
      </div>
