...
@section('styles')
<style>
    /* PAID STATUS BADGE - DARKER GREEN (same as button hover) */
    span.badge.bg-soft-primary.rounded-pill.text-capitalize.paid-status-badge,
    .badge.bg-soft-primary.paid-status-badge,
    .paid-status-badge {
                                ...
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge rounded-pill text-capitalize" style="background-color: #004d26 !important; color: #ffffff !important;">
                                                    {{ $order->payment_status }}
                                                </span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            @can('manage_orders')
                                                ...
                                                <a href="{{ route('admin.orders.printDeliverySlip', $order->id) }}"
                                                    class="btn btn-sm p-0 tt-delivery-slip" target="__blank" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="{{ localize('Print Delivery Slip') }}">
