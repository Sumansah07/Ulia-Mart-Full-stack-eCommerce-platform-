                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="partner_with_text" class="form-label">{{ localize('Partner With Text') }}</label>
                                    <input type="hidden" name="types[]" value="partner_with_text">
                                    <textarea name="partner_with_text" id="partner_with_text" class="editor form-control">{{ getSetting('partner_with_text') }}</textarea>
                                </div>
