        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="/admin/direct-product-update" method="POST" class="pb-650" id="product-form">
                        @csrf
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label for="additional_information" class="form-label">{{ localize('Additional Information') }}</label>
                                    <textarea id="additional_information" class="editor" name="additional_information">{{ $product->collectLocalization('additional_information', $lang_key) }}</textarea>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#product-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '/admin/direct-product-update',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
