...
@section('contents')
                        ...
                        <div class="tt-payment-gateway rounded-3 shadow-sm card border-0 h-100 flex-column cursor-pointer"
                            ...
                            <div class="card-body tt-payment-info">
                                <div class="d-flex align-items-center justify-content-between">
                                    <img class="img-fluid" src="{{ is_numeric($payment_gateway->image) ? uploadedAsset($payment_gateway->image) : imagePath($payment_gateway->image) }}"
                                        alt="{{ $payment_gateway->gateway }}" />
    ...
    @include('paymentgateway::settings.paymentForm.imepay')
    @include('paymentgateway::settings.paymentForm.fonepay')
