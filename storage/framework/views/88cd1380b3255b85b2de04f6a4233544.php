...
<div class="mobile-toolbar d-block d-md-none d-lg-none">
    <div class="d-table">
        <!-- Home -->
        <a class="mobile-toolbar-item <?php echo e($isHome ? 'active' : ''); ?>" href="<?php echo e(route('home')); ?>">
        ...
        <!-- Shop -->
        <a class="mobile-toolbar-item <?php echo e($isShop ? 'active' : ''); ?>" href="<?php echo e(route('products.index')); ?>">
            <span class="mobile-toolbar-icon">
        ...
        <!-- Cart -->
        <a class="mobile-toolbar-item <?php echo e($isCart ? 'active' : ''); ?>" href="<?php echo e(route('carts.index')); ?>">
            <?php
                $carts = [];
                if (Auth::check()) {
            ...
            <span class="mobile-toolbar-icon">
                ...
                <small class="badge bg-danger cart-counter"><?php echo e(count($carts)); ?></small>
                <?php endif; ?>
            </span>
        ...
        <!-- Account -->
        <a class="mobile-toolbar-item <?php echo e($isAccount ? 'active' : ''); ?>" href="<?php echo e(route('customers.dashboard')); ?>">
            <span class="mobile-toolbar-icon">
...
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/frontend/default/inc/bottomToolbar.blade.php ENDPATH**/ ?>