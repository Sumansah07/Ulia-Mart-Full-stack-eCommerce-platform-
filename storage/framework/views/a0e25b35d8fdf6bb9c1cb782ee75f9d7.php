...
<div class="top-bar">
    ...
    <div class="top-bar-content d-flex flex-row flex-wrap justify-content-between align-items-center">
            ...
            <div class="top-bar-item top-bar-left text-start">
                <span class="top-date"><?php echo e(date('l, F j, Y')); ?></span>
            </div>
            ...
            margin-bottom: 0 !important;
                        ...
                        <ul class="user-menu">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->user_type == 'customer'): ?>
                                    <li><a href="<?php echo e(route('customers.dashboard')); ?>"><span class="me-2"><i
                                                    class="fa-solid fa-user"></i></span><?php echo e(localize('My Account')); ?></a>
                                    </li>
                                    <li><a href="<?php echo e(route('customers.orderHistory')); ?>"><span
                                                class="me-2"><i
                                                    class="fa-solid fa-tags"></i></span><?php echo e(localize('My Orders')); ?></a>
                                    </li>
                                    <li><a href="<?php echo e(route('customers.wishlist')); ?>"><span class="me-2"><i
                                                    class="fa-solid fa-heart"></i></span><?php echo e(localize('My Wishlist')); ?></a>
                                    </li>
                                <?php elseif(auth()->user()->user_type == 'deliveryman'): ?>
                                    <li><a href="<?php echo e(route('deliveryman.dashboard')); ?>"><span
                                                class="me-2"><i
                                                    class="fa-solid fa-bars"></i></span><?php echo e(localize('Dashboard')); ?></a>
                                    </li>
                                <?php else: ?>
                                    <li><a href="<?php echo e(route('admin.dashboard')); ?>"><span class="me-2"><i
                                                    class="fa-solid fa-bars"></i></span><?php echo e(localize('Dashboard')); ?></a>
                                    </li>
                                <?php endif; ?>

                                <li><a href="<?php echo e(route('logout')); ?>"><span class="me-2"><i
                                                class="fa-solid fa-arrow-right-from-bracket"></i></span><?php echo e(localize('Log Out')); ?>

                                    </a></li>
                            <?php endif; ?>

                            <?php if(auth()->guard()->guest()): ?>
                                <li><a href="<?php echo e(route('login')); ?>"><span class="me-2"><i
                                                class="fa-solid fa-arrow-right-from-bracket"></i></span><?php echo e(localize('Log In')); ?></a>
                                </li>
                                <li><a href="<?php echo e(route('register')); ?>"><span class="me-2"><i
                                                class="fa-solid fa-user-plus"></i></span><?php echo e(localize('Registration')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <!-- <div class="dropdown">
                    <a href="#" class="dropdown-toggle text-uppercase text-light" data-bs-toggle="dropdown">
                        <?php echo e($currentCurrency?->symbol); ?> <?php echo e($currentCurrency?->code); ?>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-md-2 col-4 d-flex align-items-center">
                ...
                <a href="<?php echo e(route('home')); ?>" class="logo"><img
                        src="<?php echo e(staticAsset('frontend/default/assets/images/uliaa-mart-logo.jpeg')); ?>" alt="Uliaa Mart" class="img-fluid"></a>
            </div>

            <!-- Search -->
            <div class="col-lg-6 col-md-6 d-none d-md-block">
                <form class="search-container" action="<?php echo e(route('products.index')); ?>">
                    <input type="text" placeholder="<?php echo e(localize('Search for products')); ?>" class="search-input" name="search"
                        <?php if(isset($searchKey)): ?> value="<?php echo e($searchKey); ?>" <?php endif; ?>>
            ...
            <div class="col-lg-4 col-md-4 col-8">
                <div class="header-right">
                    ...
                    <div class="order-info d-none d-lg-block">
                        ...
                        <div class="phone-number"><?php echo e(getSetting('navbar_contact_number')); ?></div>
                    </div>
                    ...
                    <div class="gshop-header-cart position-relative">
                        ...
                        <button type="button" class="header-icon">
                            ...
                            <span class="cart-counter badge rounded-circle p-0 <?php echo e(count($carts) > 0 ? '' : 'd-none'); ?>"><?php echo e(count($carts)); ?></span>
                            <?php
                            ...
                            ?>
                            <span class="cart-amount ms-2"><?php echo e(formatPrice($cartAmount)); ?></span>
                        </button>
                        <div class="cart-box-wrapper">
                            <div class="apt_cart_box theme-scrollbar">
                                <ul class="at_scrollbar scrollbar cart-navbar-wrapper">
                                    <!--cart listing-->
                                    <?php echo $__env->make('frontend.default.pages.partials.carts.cart-navbar', [
                                        'carts' => $carts,
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-3">
                                    ...
                                    ?>
                                    <span class="fw-semibold text-secondary sub-total-price"><?php echo e(formatPrice($cartSidebarSubtotal2)); ?></span>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <a href="<?php echo e(route('carts.index')); ?>"
                                            class="btn btn-secondary btn-md mt-4 w-100"><span
                                                class="me-2"><i
                                                    class="fa-solid fa-shopping-bag"></i></span><?php echo e(localize('View Cart')); ?></a>
                                    </div>
                                    <div class="col-6">
                                        <a href="<?php echo e(route('checkout.proceed')); ?>"
                                            class="btn btn-primary btn-md mt-4 w-100"><span class="me-2"><i
                                                    class="fa-solid fa-credit-card"></i></span><?php echo e(localize('Checkout')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="mobile-search d-md-none">
    <div class="container">
        <form class="search-container" action="<?php echo e(route('products.index')); ?>">
            <input type="text" class="search-input" placeholder="<?php echo e(localize('Search for products')); ?>" name="search"
                <?php if(isset($searchKey)): ?> value="<?php echo e($searchKey); ?>" <?php endif; ?>>
...
<?php echo $__env->make('frontend.default.inc.uliaa-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
function redirectToTrackOrder() {
    ...
    if (isMobile && !isTablet) {
        ...
        window.location.href = "<?php echo e(route('customers.dashboard')); ?>#orders-tracker";
    } else {
        // Desktop/Tablet: redirect to dedicated track order page
        window.location.href = "<?php echo e(route('customers.trackOrder')); ?>";
    }
}
</script>
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/frontend/default/inc/uliaa-header.blade.php ENDPATH**/ ?>