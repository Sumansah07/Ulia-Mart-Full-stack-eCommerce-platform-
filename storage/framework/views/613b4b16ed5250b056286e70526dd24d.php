<script type="module">
    import {Uppy, Dashboard, ImageEditor, DropTarget, XHRUpload} from "<?php echo e(staticAsset('backend/assets/js/vendors/uppy.min.js')); ?>"
    var uppy = new Uppy({
            restrictions: { 
...
<script>
    ...
    async function getMediaFiles(getMediaType = TT.getMediaType, getMediaSearch = TT.getMediaSearch, search = false) {
        ...
        let url = '<?php echo e(route('uppy.index')); ?>';
    ...
    async function getSelectedMediaFiles(mediaIds, target = TT.showSelectedFilesDiv) {
        ...
        $.ajax({
            ...
            url: '<?php echo e(route('uppy.selectedFiles')); ?>',
            success: function(data) {
...
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/backend/inc/media-manager/uppyScripts.blade.php ENDPATH**/ ?>