            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="content-404 text-center">
                        <img src="<?php echo e(staticAsset('frontend/default/assets/img/404.png')); ?>" alt="not found"
                            class="img-fluid">
...
<?php echo $__env->make('frontend.default.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/errors/404.blade.php ENDPATH**/ ?>