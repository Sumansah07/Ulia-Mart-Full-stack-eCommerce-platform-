    ...
    <?php if(getSetting('enable_preloader') != '0'): ?>
        <div id="preloader" class="bg-light-subtle">
            <div class="preloader-wrap">
                <img src="<?php echo e(uploadedAsset(getSetting('admin_panel_preloader')) ?? staticAsset('frontend/default/assets/images/uliaa-mart-logo.jpeg')); ?>"
...
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/backend/layouts/master.blade.php ENDPATH**/ ?>