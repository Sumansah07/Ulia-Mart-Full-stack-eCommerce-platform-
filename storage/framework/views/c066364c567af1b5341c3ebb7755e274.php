...
<script src="<?php echo e(staticAsset('backend/custom/admin-buttons.js')); ?>"></script>
...
<script>
        ...
        function setPoints() {
            $('.points-input').on("focusout", function(e) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('admin.rewards.storeEachProductPoints')); ?>",
                    type: 'POST',
                    data: {
                        points: points,
    ...
    function updateDeliveryStatusByDeliveryman(status, order_id) {
        $.post('<?php echo e(route('deliveryman.updateDeliveryStatus')); ?>', {
...
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/backend/inc/scripts.blade.php ENDPATH**/ ?>