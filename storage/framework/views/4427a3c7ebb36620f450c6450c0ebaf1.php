            ...
            <div class="navbar collapse navbar-collapse" style="display: flex !important;">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dropdown" style="margin-right: 2px !important;">
                        <button class="dropbtn desktop-dropdown-btn" data-category-id="<?php echo e($category->id); ?>" data-parent-id="0" style="padding: 2px 2px !important;">
                            <?php echo e($category->collectLocalization('name')); ?>

                        </button>
                        <a class="dropbtn tablet-direct-link" href="{class="navbar collapse navbar-collapse"{ route('products.index') }}?category_id=<?php echo e($category->id); ?>"
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="mobileNav" style="width: 95%; max-width: 450px;">
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('products.index')); ?>?category_id=<?php echo e($category->id); ?>" data-category-id="<?php echo e($category->id); ?>" data-parent-id="0">
                        <?php echo e($category->collectLocalization('name')); ?>
                    ...
                    <?php if($mobileSubcategories->count() > 0): ?>
                        <ul class="submenu">
                            <?php $__currentLoopData = $mobileSubcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mobileSubcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a class="nav-link" href="<?php echo e(route('products.index')); ?>?category_id=<?php echo e($mobileSubcategory->id); ?>" data-category-id="<?php echo e($mobileSubcategory->id); ?>" data-parent-id="<?php echo e($category->id); ?>">
                                        <?php echo e($mobileSubcategory->collectLocalization('name')); ?>
        ...
        <div class="d-grid gap-3 mt-4">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('customers.dashboard')); ?>" class="btn btn-outline-secondary" style="font-size: 16px; padding: 10px 0;">My Account</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary" style="font-size: 16px; padding: 10px 0;">Login / Register</a>
            <?php endif; ?>
            <?php if(auth()->guard()->check()): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>?redirect=track-order" class="btn btn-success" style="font-size: 16px; padding: 10px 0;">Track Order</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php /**PATH D:\Suman-ogani\uliaa.infiniteitsolutionsnepal.com\resources\views/frontend/default/inc/uliaa-nav.blade.php ENDPATH**/ ?>