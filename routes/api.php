...
Route::controller(AuthController::class)->group(function(){
    ...
    Route::post("login","login")->name('api.login')->middleware('isBanned');
    Route::get("token-check","checkToken")->name('api.token-check')->middleware('isBanned');
});
...
Route::controller(CategoryController::class)->group(function(){
    ...
    Route::get('fallback-categories',"fallbackCategories");
});
