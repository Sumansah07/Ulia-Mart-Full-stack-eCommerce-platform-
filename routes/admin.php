...
use App\Http\Controllers\Backend\EmailMarketing\EmailTemplatesController;
use App\Http\Controllers\Backend\EmailMarketing\EmailCampaignsController;
...
// Direct product update route without middleware
Route::post('/admin/direct-product-update', [App\Http\Controllers\Backend\Products\ProductsController::class, 'update'])
    ->middleware(['auth', 'admin'])
    ->name('admin.products.direct.update');
...
Route::group(
    ...
    function () {
        ...
        Route::group(['prefix' => 'orders'], function () {
            ...
            Route::get('/delivery-slip-print/{id}', [OrdersController::class, 'generateDeliverySlip'])->name('admin.orders.printDeliverySlip');
            Route::get('/delivery-slip-download/{id}', [OrdersController::class, 'downloadDeliverySlip'])->name('admin.orders.downloadDeliverySlip');
        });
        ...
        Route::controller(EmailTemplatesController::class)->group(function () {
            Route::get('/email-marketing/templates', 'index')->name('admin.email-marketing.templates.index');
            Route::get('/email-marketing/templates/create', 'create')->name('admin.email-marketing.templates.create');
            Route::get('/email-marketing/templates/sample-variables', 'editSampleVariables')->name('admin.email-marketing.templates.sample-variables');
            Route::post('/email-marketing/templates/sample-variables', 'updateSampleVariables')->name('admin.email-marketing.templates.sample-variables.update');
            Route::post('/email-marketing/templates/create-defaults', 'createDefaults')->name('admin.email-marketing.templates.create-defaults');
            Route::post('/email-marketing/templates', 'store')->name('admin.email-marketing.templates.store');
            Route::get('/email-marketing/templates/{template}', 'show')->name('admin.email-marketing.templates.show');
            Route::get('/email-marketing/templates/{template}/edit', 'edit')->name('admin.email-marketing.templates.edit');
            Route::put('/email-marketing/templates/{template}', 'update')->name('admin.email-marketing.templates.update');
            Route::delete('/email-marketing/templates/{template}', 'destroy')->name('admin.email-marketing.templates.destroy');
            Route::post('/email-marketing/templates/{template}/toggle-status', 'toggleStatus')->name('admin.email-marketing.templates.toggle-status');
            Route::get('/email-marketing/templates/{template}/preview', 'preview')->name('admin.email-marketing.templates.preview');
            Route::post('/email-marketing/templates/{template}/duplicate', 'duplicate')->name('admin.email-marketing.templates.duplicate');
        });



        # email marketing - campaigns
        Route::controller(EmailCampaignsController::class)->group(function () {
            Route::get('/email-marketing/campaigns', 'index')->name('admin.email-marketing.campaigns.index');
            Route::get('/email-marketing/campaigns/create', 'create')->name('admin.email-marketing.campaigns.create');
            Route::post('/email-marketing/campaigns', 'store')->name('admin.email-marketing.campaigns.store');
            Route::get('/email-marketing/campaigns/{campaign}', 'show')->name('admin.email-marketing.campaigns.show');
            Route::get('/email-marketing/campaigns/{campaign}/edit', 'edit')->name('admin.email-marketing.campaigns.edit');
            Route::put('/email-marketing/campaigns/{campaign}', 'update')->name('admin.email-marketing.campaigns.update');
            Route::delete('/email-marketing/campaigns/{campaign}', 'destroy')->name('admin.email-marketing.campaigns.destroy');
            Route::post('/email-marketing/campaigns/{campaign}/send', 'send')->name('admin.email-marketing.campaigns.send');
            Route::get('/email-marketing/campaigns/{campaign}/preview', 'preview')->name('admin.email-marketing.campaigns.preview');
            Route::post('/email-marketing/campaigns/{campaign}/duplicate', 'duplicate')->name('admin.email-marketing.campaigns.duplicate');
            Route::post('/email-marketing/get-audience-count', 'getAudienceCount')->name('admin.email-marketing.campaigns.get-audience-count');
        });
        ...
        Route::group(['prefix' => 'reports'], function () {
            ...
            Route::get('/product-sales/export', [ReportsController::class, 'exportProductSales'])->name('admin.reports.sales.export');
            Route::get('/category-wise-sales/export', [ReportsController::class, 'exportCategorySales'])->name('admin.reports.categorySales.export');
            Route::get('/sales-amount-report/export', [ReportsController::class, 'exportSalesAmount'])->name('admin.reports.salesAmount.export');
            Route::get('/delivery-status-report/export', [ReportsController::class, 'exportDeliveryStatus'])->name('admin.reports.deliveryStatus.export');
        });
